...
\usepackage[orientation=portrait,size=custom,width=55.9,height=86.4,scale=1]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size
