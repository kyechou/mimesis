...
macro(bpf_object name input)
    ...
    get_filename_component(SRC_DIR ${BPF_C_FILE} DIRECTORY)
    ...
    add_dependencies(${OUTPUT_TARGET} libxdp libbpf)
    ...
    target_include_directories(${OUTPUT_TARGET} SYSTEM INTERFACE ${libxdp_INCLUDE_DIRS} ${libbpf_INCLUDE_DIRS})
    target_link_libraries(${OUTPUT_TARGET} INTERFACE ${libxdp_LIBRARIES} ${libbpf_LIBRARIES} -lelf ZLIB::ZLIB)
endmacro()
