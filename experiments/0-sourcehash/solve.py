...
parser = argparse.ArgumentParser(description='Source-based hashing experiment')
parser.add_argument('--input-addr', dest='input_addr')
parser.add_argument('--input-port', dest='input_port', type=int)
parser.add_argument('--output-addr', dest='output_addr')
parser.add_argument('--output-port', dest='output_port', type=int)
arg = parser.parse_args()
if arg.input_addr:
    arg.input_addr = int(arg.input_addr, 16)
if arg.output_addr:
...
print('cli_addr:', cli_ip)
print('cli_port:', cli_port)
print('addr:', addr)
print('port:', port)
print('Evaluated cli_addr:', hex(s4.solver.eval(cli_ip)))
